...
import org.kalnee.topcommerce.service.MailService;
import org.kalnee.topcommerce.service.UserService;
import org.kalnee.topcommerce.service.dto.UserDTO;
import org.kalnee.topcommerce.service.mapper.UserMapper;
import org.kalnee.topcommerce.web.rest.errors.ExceptionTranslator;
import org.kalnee.topcommerce.web.rest.vm.ManagedUserVM;
...
public class UserResourceIntTest {
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(containsInAnyOrder("ROLE_USER", "ROLE_MANAGER", "ROLE_ADMIN")));
    }
